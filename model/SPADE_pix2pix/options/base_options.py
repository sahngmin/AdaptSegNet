...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--label_nc', type=int, default=10, help='# of input label classes without unknown class. If you have unknown class as class label, specify --contain_dopntcare_label.')
        parser.add_argument('--contain_dontcare_label', action='store_false', help='if the label map contains dontcare label (dontcare=255)', default=False)
        ...
        parser.add_argument('--ngf', type=int, default=4, help='# of gen filters in first conv layer')
        ...
        parser.add_argument('--no_instance', action='store_true', help='if specified, do *not* add instance map as input', default=False)
